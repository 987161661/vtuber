...
description: Query Linglan's local Typhoon Boss Radar for current tropical-cyclone facts, representative-city wind speed and Beaufort force, regional impact, forecast-track timing, landfall evidence, and source attribution. Use for Chinese live-chat questions such as 某地几级风, 某地现在风大不大, 台风对某省市有什么影响, 什么时候登陆或到达, 当前台风位置强度, and 信息从哪里查到的.
---
