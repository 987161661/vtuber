...
export function buildCharacterSystemPrompt(
  ...
  options: { speechPlanV2Enabled?: boolean } = {},
): string {
  const legacySchema =
  ...
  const schema = speechPlanV2Enabled
    ? '{"version":2,"beats":[{"text":"这一节真正说出口的话","emotion":"neutral|happy|sad|angry|surprised|relaxed","delivery":"natural|warm|playful|calm|excited|soft|serious|teasing","emotion_intensity":0.0,"motion":"idle_cold|side_glance|lean_in|smirk|restrained_laugh|serious_report|thank_gift|dismissive","gaze":"camera|left|right|down","gesture":"still|subtle|expressive","vocal_tags":[],"pause_after_ms":0,"interruptible_after":true}]}'
    : legacySchema;
